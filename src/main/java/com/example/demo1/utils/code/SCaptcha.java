...
public class SCaptcha {
    ...
    //只含数字
    private char[] numSequence = {  '1', '2', '3', '4', '5', '6', '7', '8', '9' };
    //数字加字母
    ...
    public static void main(String[] args) {
        ...
        log.info("图片验证码内容为：{}",instance.getCode());
        // 向页面输出验证码图片
        //instance.write(response.getOutputStream());
        BufferedImage mergePicture = instance.getBuffImg();
        byte[] bytes = QRCodeUtil.imageToBytes(mergePicture, "png");
        BASE64Encoder encoder = new BASE64Encoder();
        String base64String = "";
        base64String = encoder.encodeBuffer(bytes).trim();
        base64String = base64String.replaceAll("\n", "").replaceAll("\r", "");// 删除 \r\n
        log.info("图片验证码base64为：{data:image/png;base64,{}}",base64String);
    }
    ...
    public void createCode() {
        ...
        for (int i = 0; i < codeCount; i++) {
            String strRand = String.valueOf(numSequence[random.nextInt(numSequence.length)]);
            // 设置字体颜色
    ...
    class ImgFontByte {
        ...
        private String getFontByteStr() {
            ...
            //return ReadFontByteProperties.getFontByteStr();// 未找到配置文件
            return null;
        }
    }
}
